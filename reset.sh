...
echo "  ./ralph/run.sh [model] [max_iterations]"
echo "  ./ralph/run.sh              # haiku, 5 iterations (default)"
echo "  ./ralph/run.sh opus 5       # opus, 5 iterations"
echo "  ./ralph/run.sh 5            # haiku, 5 iterations (backward compatible)"
echo ""
